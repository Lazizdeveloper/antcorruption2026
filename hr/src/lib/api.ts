import { Anomaly, Application, DashboardSummary, HrProfile } from '../types';
...
export async function updateProfile(profile: HrProfile) {
  const payload = await requestJson<{ profile: HrProfile }>(
    '/api/hr/profile',
    {
      method: 'PUT',
